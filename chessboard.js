...
// Función para limpiar resaltado de casilla sin lógica de colores
...
var levels = [
  {
      fen: '7k/pppp1ppp/8/8/8/8/PP3PPP/4R1K1 w - - 0 1',
      correctMoves: ["e1e8"] // Blancas dan jaque mate con la torre
  },
  {
      fen: 'r6k/pppp1ppp/8/8/8/8/PPPPRPPP/4R2K w - - 1 1',
      correctMoves: ["e2e8", "a8e8", "e1e8"], // Movimientos correctos
      autoMoveBlack: ["a8e8"] // Movimientos automáticos de las negras
  }
];
var currentLevel = 0;
var correctMoves = levels[currentLevel].correctMoves; // Movimientos correctos del nivel actual
var currentMoveIndex = 0; // Índice del movimiento actual
...
function loadLevel(levelIndex) {
  ...
  correctMoves = level.correctMoves; // Actualizar movimientos correctos
  currentMoveIndex = 0; // Reiniciar el índice de movimientos
  ...
  // INICIALIZADOR DE TABLERO
  (function init_all() {

    set_fen('7k/pppp1ppp/8/8/8/8/PP3PPP/4R1K1 w - - 0 1');
